...
public class ApplicationConstants {
    ...
    private static final String baseApi = "https://mobile.entrancei.com/";
    public static final String get_request_token =  baseApi+"dsfiuhiudeewrhuih";
    public static final String request_otp = baseApi+"user-registration-request-otp";
    public static final String validate_otp =  baseApi+"user-registration-validate-otp";
